...
bool fuzzy_match( char const *pattern, char const *str, int &outScore, uint8_t *matches,
                  int maxMatches );
}
...
{
bool fuzzy_match_recursive( const char *pattern, const char *str, int &outScore,
                            const char  *strBegin,
...
bool fuzzy_internal::fuzzy_match_recursive( const char *pattern, const char *str,
        int &outScore,
